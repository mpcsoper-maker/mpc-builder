...
export const PREBUILTS: Prebuilt[] = [
  {
    ...
    parts: [
      { category: "CPU", name: "Ryzen 5 7600", price: 152 },
      { category: "GPU", name: " MSI GeForce RTX 5070 12G", price: 589 },
      { category: "RAM", name: "Crucial Pro OC Schwarz 32GB Kit (2x16GB) DDR5-6000 CL36", price: 399 },
      { category: "Storage", name: "Lexar NQ790 SSD 1TB M.2 2280 PCIe Gen4 NVMe", price: 142,},
      { category: "Motherboard", name: "ASRock B650M-H/M.2+ Mainboard", price: 79 },
      { category: "PSU", name: "be quiet! SYSTEM POWER 11 750W | PC-Netzteil", price: 72 },
      { category: "Case", name: "ASUS Prime AP201 TG | MicroATX PC-Gehäuse", price: 80 },
      { category: "m-pcs-cut", name: "m-pcs-cut", price: 20 },
      { category: "stripe", name: "stripe", price: 24 },
    ],
  },
];
